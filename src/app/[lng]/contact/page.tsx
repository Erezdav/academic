    ...
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-center mb-12">
          {lng === 'he' ? 'צור קשר' : lng === 'ar' ? 'اتصل بنا' : 'Contact Us'}
        </h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h2 className="text-2xl font-semibold mb-6">
              {lng === 'he' ? 'שלח לנו הודעה' : lng === 'ar' ? 'أرسل لنا رسالة' : 'Send us a message'}
            </h2>
            <ContactForm lng={lng} />
          </div>
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6">
              {lng === 'he' ? 'חפש במאמרים שלנו' : lng === 'ar' ? 'ابحث في مقالاتنا' : 'Search our articles'}
            </h2>
            <ArticleSearch lng={lng} />
            
            <div className="mt-12">
              <h2 className="text-2xl font-semibold mb-6">
                {lng === 'he' ? 'צ\'אט חי' : lng === 'ar' ? 'دردشة مباشرة' : 'Live Chat'}
              </h2>
              <LiveChat lng={lng} />
            </div>
          </div>
